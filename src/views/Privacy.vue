    ...
    <section class="py-16 bg-gradient-to-b from-solar-dark to-solar-gray">
      <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto text-center">
          <h1
            class="text-4xl md:text-6xl font-display font-bold text-gradient mb-6"
          >
            Privacy Policy
          </h1>
          ...
          <div class="prose prose-invert max-w-none">
            ...
            <div class="mb-12">
              ...
              <ul class="list-disc list-inside text-solar-light/80 space-y-2">
                ...
                <li>Improving user experience and Site functionality</li>
...
/* Button styles */
.btn-primary {
  @apply bg-solar-orange text-white px-6 py-3 rounded-lg hover:bg-solar-orange/80 transition-colors font-semibold;
}
</style>
